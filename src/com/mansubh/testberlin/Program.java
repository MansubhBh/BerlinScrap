 ...
 */
package com.mansubh.testberlin;
...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            int count = 1;
            int checkparam = 0;
            FileWriter writer = new FileWriter("/home/mansubh/berlin12.csv");
            for (int i = 1; i <= 41; i++) {

                String main_url = base_url + i;
                Document docs = Jsoup.connect(main_url).get();
                Elements allelements = docs.select("div.col-md-12 div.row a");

                for (Element e : allelements) {

                    String innerlink = e.attr("href");
                    Document innerdoc = Jsoup.connect(innerlink).get();
